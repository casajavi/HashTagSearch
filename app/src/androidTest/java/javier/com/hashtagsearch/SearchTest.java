    ...
    public void searchTest() {
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(R.id.search_src_text),
                        ...
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("starwars"), closeSoftKeyboard());

        ViewInteraction searchAutoComplete2 = onView(
                allOf(withId(R.id.search_src_text), withText("starwars"),
                        withParent(allOf(withId(R.id.search_plate),
                                withParent(withId(R.id.search_edit_frame)))),
                        isDisplayed()));
        ...
        ViewInteraction appCompatImageView = onView(
                allOf(withId(R.id.imageView_tweet),
                        withParent(withId(R.id.layout_tweet_image)),
                        isDisplayed()));
        ...
        ViewInteraction searchAutoComplete3 = onView(
                allOf(withId(R.id.search_src_text),
                        withParent(allOf(withId(R.id.search_plate),
                                withParent(withId(R.id.search_edit_frame)))),
                        isDisplayed()));
        searchAutoComplete3.perform(replaceText("007"), closeSoftKeyboard());

        ViewInteraction searchAutoComplete4 = onView(
                allOf(withId(R.id.search_src_text), withText("007"),
                        withParent(allOf(withId(R.id.search_plate),
                                withParent(withId(R.id.search_edit_frame)))),
                        isDisplayed()));
